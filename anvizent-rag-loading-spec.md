...
- **Source:** Successfully deployed pipeline JSON specs; spec-library commits; curated canonical Silver templates.
- **Trigger:** Deployment-success event; spec commit; manual template publish.
...
- **Refresh:** Continuous / event-driven on successful deployment.
